...
//            String address = txtAdressBottomSheet.getText().toString();
            ...
            if (TextUtils.isEmpty(code) || TextUtils.isEmpty(contact)) {
...
//                        AppNotification();
                        Intent intent = new Intent(AboutArt.this, MapsActivity.class);
                        intent.putExtra("postID", postID);
                        intent.putExtra("publisher", publisher);
                        intent.putExtra("postPublisher", postPublisher);
...
//           }
    ...
    public void addNotificationForBuyer(String postID, String publisher, String text) {
    ...
    public void addNotificationForSeller(String postID, String publisher, String text) {
        HashMap<String, Object> map = new HashMap<>();
        map.put("userID", publisher);
        map.put("text", text);
        map.put("postID", postID);
